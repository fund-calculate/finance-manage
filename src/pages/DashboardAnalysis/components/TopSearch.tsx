...
const columns = [
  ...
  {
    title: (
      <FormattedMessage id="dashboardanalysis.table.search-keyword" defaultMessage="Search keyword" />
    ),
    dataIndex: 'keyword',
    key: 'keyword',
  ...
  {
    title: <FormattedMessage id="dashboardanalysis.table.weekly-range" defaultMessage="Weekly Range" />,
    dataIndex: 'range',
    key: 'range',
